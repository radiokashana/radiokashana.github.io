...
const Footer = () =>
	<footer className="white w-100 tc bg-near-black cl" data-testid="site-footer">
		...
		<h3 className="ma0" data-testid="footer-frequency">Transmitiendo en la 93.3 FM desde el punto m&aacute;s alto de Santa Rosal&iacute;a, Baja California Sur</h3>
		<h3 className="ma0" data-testid="footer-contact">Cel. 615 155 8484 rafael@radiokashana.org</h3>
	</footer>
